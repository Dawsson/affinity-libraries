...
class TestCreateOrderRequestAnyOf(unittest.TestCase):
    """CreateOrderRequestAnyOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrderRequestAnyOf:
        """Test CreateOrderRequestAnyOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrderRequestAnyOf`
        """
        model = CreateOrderRequestAnyOf()
        if include_optional:
            return CreateOrderRequestAnyOf(
                catalog_item_id = '0',
                practice_id = '0',
                directions = '0',
                external_order_id = '0',
    ...
    def testCreateOrderRequestAnyOf(self):
        """Test CreateOrderRequestAnyOf"""
