    ...
    def make_instance(self, include_optional) -> CreateOrderRequest:
        ...
        if include_optional:
            return CreateOrderRequest(
                ...
                directions = '0',
                external_order_id = '0',
                patient = affinity_sdk.models.create_order_request_any_of_patient.createOrder_request_anyOf_patient(
                    address = affinity_sdk.models.create_order_request_any_of_patient_address.createOrder_request_anyOf_patient_address(
                        city = '0', 
                        country = 'US', 
                        line1 = '0', 
                        line2 = '', 
                    ...
                    external_patient_id = '0', 
                    name = '0', 
                    phone = '0123456', 
                    state = '01', ),
                prescriber = affinity_sdk.models.create_order_request_any_of_prescriber.createOrder_request_anyOf_prescriber(
                    credentials = '0', 
                    license_states = [
                        '01'
                        ], 
                    name = '0', 
                    npi = '0480728880', ),
                prescription = affinity_sdk.models.create_order_request_any_of_prescription.createOrder_request_anyOf_prescription(
                    authorized = true, 
                    signed_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                quantity = 0,
                replaces_order_id = 'ffffffff-ffff-ffff-ffff-ffffffffffff',
