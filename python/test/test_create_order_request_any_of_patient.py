...
class TestCreateOrderRequestAnyOfPatient(unittest.TestCase):
    """CreateOrderRequestAnyOfPatient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrderRequestAnyOfPatient:
        """Test CreateOrderRequestAnyOfPatient
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrderRequestAnyOfPatient`
        """
        model = CreateOrderRequestAnyOfPatient()
        if include_optional:
            return CreateOrderRequestAnyOfPatient(
    ...
    def testCreateOrderRequestAnyOfPatient(self):
        """Test CreateOrderRequestAnyOfPatient"""
