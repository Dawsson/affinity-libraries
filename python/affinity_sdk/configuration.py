...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "affinityApiKey": APIKeyAuthSetting,
...
conf = affinity_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.joinaffinityai.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("affinity_sdk")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'affinityApiKey' in self.api_key:
            auth['affinityApiKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-affinity-api-key',
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://api.joinaffinityai.com",
