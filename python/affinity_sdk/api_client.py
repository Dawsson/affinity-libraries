...
from affinity_sdk.api_response import ApiResponse, T as ApiResponseT
import affinity_sdk.models
from affinity_sdk import rest
from affinity_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(affinity_sdk.models, klass)
