...
class RotateWebhookEndpointSecretResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "enabledEvents", "id", "livemode", "object", "status", "updatedAt", "url", "signingSecret"]
