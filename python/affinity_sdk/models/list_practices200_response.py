...
class ListPractices200Response(BaseModel):
    """
    ListPractices200Response
    """ # noqa: E501
    data: List[ListPractices200ResponseDataInner]
    has_more: StrictBool = Field(alias="hasMore")
    object: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["data", "hasMore", "object"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ListPractices200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
