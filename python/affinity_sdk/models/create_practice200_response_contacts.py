...
class CreatePractice200ResponseContacts(BaseModel):
    """
    CreatePractice200ResponseContacts
    """ # noqa: E501
    compliance: Optional[ListPractices200ResponseDataInnerContactsPrimary]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compliance": ListPractices200ResponseDataInnerContactsPrimary.from_dict(obj["compliance"]) if obj.get("compliance") is not None else None,
