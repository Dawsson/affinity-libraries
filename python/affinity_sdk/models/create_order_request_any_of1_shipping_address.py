...
class CreateOrderRequestAnyOf1ShippingAddress(BaseModel):
    """
    CreateOrderRequestAnyOf1ShippingAddress
    """ # noqa: E501
    city: Annotated[str, Field(min_length=1, strict=True, max_length=120)]
    country: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=2)]] = 'US'
    line1: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=180)]]
