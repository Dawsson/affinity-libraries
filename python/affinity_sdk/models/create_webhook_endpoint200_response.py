...
class CreateWebhookEndpoint200Response(BaseModel):
    ...
    signing_secret: Optional[StrictStr] = Field(alias="signingSecret")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["endpoint", "signingSecret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endpoint": CreateWebhookEndpoint200ResponseEndpoint.from_dict(obj["endpoint"]) if obj.get("endpoint") is not None else None,
