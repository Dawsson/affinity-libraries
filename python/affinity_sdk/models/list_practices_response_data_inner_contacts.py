...
class ListPracticesResponseDataInnerContacts(BaseModel):
    """
    ListPracticesResponseDataInnerContacts
    """ # noqa: E501
    compliance: Optional[ListPracticesResponseDataInnerContactsCompliance]
    primary: Optional[ListPracticesResponseDataInnerContactsCompliance]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compliance": ListPracticesResponseDataInnerContactsCompliance.from_dict(obj["compliance"]) if obj.get("compliance") is not None else None,
            "primary": ListPracticesResponseDataInnerContactsCompliance.from_dict(obj["primary"]) if obj.get("primary") is not None else None
        })
        return _obj
