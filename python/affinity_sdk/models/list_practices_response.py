...
class ListPracticesResponse(BaseModel):
    """
    ListPracticesResponse
    """ # noqa: E501
    data: List[ListPracticesResponseDataInner]
    ...
    def url_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['/v1/practices']):
            raise ValueError("must be one of enum values ('/v1/practices')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ListPracticesResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
