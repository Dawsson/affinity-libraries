...
class ListCatalogItems200Response(BaseModel):
    ...
    """ # noqa: E501
    items: List[ListCatalogItems200ResponseItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ListCatalogItems200ResponseItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
