...
class ListWebhookEndpoints200Response(BaseModel):
    ...
    """ # noqa: E501
    endpoints: List[ListWebhookEndpoints200ResponseEndpointsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endpoints": [ListWebhookEndpoints200ResponseEndpointsInner.from_dict(_item) for _item in obj["endpoints"]] if obj.get("endpoints") is not None else None
        })
