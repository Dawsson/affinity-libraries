...
class ListPractices200ResponseDataInner(BaseModel):
    """
    ListPractices200ResponseDataInner
    """ # noqa: E501
    address: Optional[ListPractices200ResponseDataInnerAddress]
    ...
    object: StrictStr
    prescribers: List[ListPractices200ResponseDataInnerPrescribersInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": ListPractices200ResponseDataInnerAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "contacts": ListPractices200ResponseDataInnerContacts.from_dict(obj["contacts"]) if obj.get("contacts") is not None else None,
            ...
            "prescribers": [ListPractices200ResponseDataInnerPrescribersInner.from_dict(_item) for _item in obj["prescribers"]] if obj.get("prescribers") is not None else None,
