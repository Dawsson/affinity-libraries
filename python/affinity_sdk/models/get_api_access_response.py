...
class GetApiAccessResponse(BaseModel):
    """
    GetApiAccessResponse
    """ # noqa: E501
    api_key: GetApiAccessResponseApiKey = Field(alias="apiKey")
    livemode: StrictBool
    object: StrictStr
    scopes: List[StrictStr]
    service_account: GetApiAccessResponseServiceAccount = Field(alias="serviceAccount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["apiKey", "livemode", "object", "scopes", "serviceAccount"]

    @field_validator('object')
    def object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['api_access']):
            raise ValueError("must be one of enum values ('api_access')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apiKey": GetApiAccessResponseApiKey.from_dict(obj["apiKey"]) if obj.get("apiKey") is not None else None,
            "livemode": obj.get("livemode"),
            "object": obj.get("object"),
            "scopes": obj.get("scopes"),
            "serviceAccount": GetApiAccessResponseServiceAccount.from_dict(obj["serviceAccount"]) if obj.get("serviceAccount") is not None else None
        })
