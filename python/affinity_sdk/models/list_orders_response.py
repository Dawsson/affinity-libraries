...
class ListOrdersResponse(BaseModel):
    ...
    ListOrdersResponse
    """ # noqa: E501
    data: List[ListOrdersResponseDataInner]
    ...
    def url_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['/v1/orders']):
            raise ValueError("must be one of enum values ('/v1/orders')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ListOrdersResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
