...
class ListWebhookEvents200Response(BaseModel):
    ...
    """ # noqa: E501
    events: List[ListWebhookEvents200ResponseEventsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [ListWebhookEvents200ResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
