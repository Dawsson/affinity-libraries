...
class CreateWebhookEndpointRequest(BaseModel):
    ...
    """ # noqa: E501
    enabled_events: Optional[List[Annotated[str, Field(min_length=1, strict=True, max_length=120)]]] = Field(default=None, alias="enabledEvents")
    __properties: ClassVar[List[str]] = ["enabledEvents"]
