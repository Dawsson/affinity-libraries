...
class CreateOrderRequestAnyOf(BaseModel):
    ...
    """ # noqa: E501
    catalog_item_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="catalogItemId")
    practice_id: Annotated[str, Field(min_length=1, strict=True, max_length=160)] = Field(alias="practiceId")
    ...
    replaces_order_id: Optional[UUID] = Field(default=None, alias="replacesOrderId")
