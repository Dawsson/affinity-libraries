...
class GetPlatformOrganization200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": GetPlatformOrganization200ResponseAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "membership": GetPlatformOrganization200ResponseMembership.from_dict(obj["membership"]) if obj.get("membership") is not None else None,
            "user": GetPlatformOrganization200ResponseUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
