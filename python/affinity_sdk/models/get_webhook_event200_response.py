...
class GetWebhookEvent200Response(BaseModel):
    """
    GetWebhookEvent200Response
    """ # noqa: E501
    attempts: List[GetWebhookEvent200ResponseAttemptsInner]
    deliveries: List[GetWebhookEvent200ResponseDeliveriesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attempts": [GetWebhookEvent200ResponseAttemptsInner.from_dict(_item) for _item in obj["attempts"]] if obj.get("attempts") is not None else None,
            "deliveries": [GetWebhookEvent200ResponseDeliveriesInner.from_dict(_item) for _item in obj["deliveries"]] if obj.get("deliveries") is not None else None,
