...
class GetWebhookEvent200ResponseDeliveriesInner(BaseModel):
    """
    GetWebhookEvent200ResponseDeliveriesInner
    """ # noqa: E501
    attempt_count: Optional[Union[StrictFloat, StrictInt]] = Field(alias="attemptCount")
    endpoint_id: Optional[StrictStr] = Field(alias="endpointId")
