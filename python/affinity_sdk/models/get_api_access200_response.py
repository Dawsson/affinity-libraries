...
class GetApiAccess200Response(BaseModel):
    """
    GetApiAccess200Response
    """ # noqa: E501
    api_key: GetApiAccess200ResponseApiKey = Field(alias="apiKey")
    livemode: StrictBool
    object: StrictStr
    scopes: List[StrictStr]
    service_account: GetApiAccess200ResponseServiceAccount = Field(alias="serviceAccount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apiKey": GetApiAccess200ResponseApiKey.from_dict(obj["apiKey"]) if obj.get("apiKey") is not None else None,
            "livemode": obj.get("livemode"),
            "object": obj.get("object"),
            "scopes": obj.get("scopes"),
            "serviceAccount": GetApiAccess200ResponseServiceAccount.from_dict(obj["serviceAccount"]) if obj.get("serviceAccount") is not None else None
        })
