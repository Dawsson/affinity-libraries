...
class ListPractices200ResponseDataInnerContacts(BaseModel):
    """
    ListPractices200ResponseDataInnerContacts
    """ # noqa: E501
    compliance: Optional[ListPractices200ResponseDataInnerContactsCompliance]
    primary: Optional[ListPractices200ResponseDataInnerContactsPrimary]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["compliance", "primary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "compliance": ListPractices200ResponseDataInnerContactsCompliance.from_dict(obj["compliance"]) if obj.get("compliance") is not None else None,
            "primary": ListPractices200ResponseDataInnerContactsPrimary.from_dict(obj["primary"]) if obj.get("primary") is not None else None
        })
