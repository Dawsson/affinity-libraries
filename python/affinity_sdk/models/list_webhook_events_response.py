...
class ListWebhookEventsResponse(BaseModel):
    """
    ListWebhookEventsResponse
    """ # noqa: E501
    data: List[ListWebhookEventsResponseDataInner]
    has_more: StrictBool = Field(alias="hasMore")
    object: StrictStr
    url: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["data", "hasMore", "object", "url"]
    ...
    @field_validator('url')
    def url_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['/v1/webhook-events']):
            raise ValueError("must be one of enum values ('/v1/webhook-events')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ListWebhookEventsResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
