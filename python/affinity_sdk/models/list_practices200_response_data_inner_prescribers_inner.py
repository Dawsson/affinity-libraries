...
class ListPractices200ResponseDataInnerPrescribersInner(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if npi (nullable) is None
        # and model_fields_set contains the field
        if self.npi is None and "npi" in self.model_fields_set:
            _dict['npi'] = None
