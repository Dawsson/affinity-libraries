...
class ListOrderEvents200Response(BaseModel):
    """
    ListOrderEvents200Response
    """ # noqa: E501
    events: List[ListOrderEvents200ResponseEventsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [ListOrderEvents200ResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
