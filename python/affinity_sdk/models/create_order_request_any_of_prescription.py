...
class CreateOrderRequestAnyOfPrescription(BaseModel):
    """
    CreateOrderRequestAnyOfPrescription
    """ # noqa: E501
    authorized: StrictBool
    signed_at: datetime = Field(alias="signedAt")
    __properties: ClassVar[List[str]] = ["authorized", "signedAt"]

    @field_validator('authorized')
    def authorized_validate_enum(cls, value):
        """Validates the enum"""
    ...
    def signed_at_validate_regular_expression(cls, value):
