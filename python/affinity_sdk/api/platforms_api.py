...
class PlatformsApi:
    ...
    def get_platform_organization(
        self,
        org_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None,
        ...
        _param = self._get_platform_organization_serialize(
            org_id=org_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetPlatformOrganization200Response",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '404': "Error",
    ...
    @validate_call
    def get_platform_organization_with_http_info(
        self,
        org_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPlatformOrganization200Response]:
        """Read platform organization
    ...
    @validate_call
    def get_platform_organization_without_preload_content(
        self,
        org_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_platform_organization_serialize(
        self,
        org_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/platform/organization',
