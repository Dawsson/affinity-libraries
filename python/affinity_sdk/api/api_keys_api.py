...
class APIKeysApi:
    ...
    def get_api_access(
        ...
        _param = self._get_api_access_serialize(
    ...
    @validate_call
    def get_api_access_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetApiAccessResponse]:
        """Read API key access
    ...
    @validate_call
    def get_api_access_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
