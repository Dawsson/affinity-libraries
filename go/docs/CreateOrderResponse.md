...
`func (o *CreateOrderResponse) GetCatalogItemId() string`

GetCatalogItemId returns the CatalogItemId field if non-nil, zero value otherwise.

### GetCatalogItemIdOk

`func (o *CreateOrderResponse) GetCatalogItemIdOk() (*string, bool)`
...
`func (o *CreateOrderResponse) SetCatalogItemId(v string)`
...
`func (o *CreateOrderResponse) SetPracticeId(v string)`
...
`func (o *CreateOrderResponse) GetCompounderId() string`

GetCompounderId returns the CompounderId field if non-nil, zero value otherwise.

### GetCompounderIdOk

`func (o *CreateOrderResponse) GetCompounderIdOk() (*string, bool)`
...
`func (o *CreateOrderResponse) SetCompounderId(v string)`
...
`func (o *CreateOrderResponse) SetCompounderIdNil(b bool)`

 SetCompounderIdNil sets the value for CompounderId to be an explicit nil

### UnsetCompounderId
`func (o *CreateOrderResponse) UnsetCompounderId()`
...
`func (o *CreateOrderResponse) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *CreateOrderResponse) GetIdOk() (*string, bool)`
...
`func (o *CreateOrderResponse) SetId(v string)`
...
`func (o *CreateOrderResponse) GetReplacesOrderId() string`

GetReplacesOrderId returns the ReplacesOrderId field if non-nil, zero value otherwise.

### GetReplacesOrderIdOk

`func (o *CreateOrderResponse) GetReplacesOrderIdOk() (*string, bool)`
...
`func (o *CreateOrderResponse) SetReplacesOrderId(v string)`
...
`func (o *CreateOrderResponse) SetReplacesOrderIdNil(b bool)`

 SetReplacesOrderIdNil sets the value for ReplacesOrderId to be an explicit nil

### UnsetReplacesOrderId
`func (o *CreateOrderResponse) UnsetReplacesOrderId()`
