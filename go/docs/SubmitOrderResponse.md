...
`func (o *SubmitOrderResponse) SetCatalogItemIdNil(b bool)`

 SetCatalogItemIdNil sets the value for CatalogItemId to be an explicit nil

### UnsetCatalogItemId
`func (o *SubmitOrderResponse) UnsetCatalogItemId()`
...
`func (o *SubmitOrderResponse) SetCompounderIdNil(b bool)`

 SetCompounderIdNil sets the value for CompounderId to be an explicit nil

### UnsetCompounderId
`func (o *SubmitOrderResponse) UnsetCompounderId()`
...
`func (o *SubmitOrderResponse) SetReplacesOrderIdNil(b bool)`

 SetReplacesOrderIdNil sets the value for ReplacesOrderId to be an explicit nil

### UnsetReplacesOrderId
`func (o *SubmitOrderResponse) UnsetReplacesOrderId()`
