 ...
 */
@JsonPropertyOrder({
  ListPractices200ResponseDataInnerContactsPrimary.JSON_PROPERTY_EMAIL,
  ListPractices200ResponseDataInnerContactsPrimary.JSON_PROPERTY_NAME,
  ListPractices200ResponseDataInnerContactsPrimary.JSON_PROPERTY_PHONE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListPractices200ResponseDataInnerContactsPrimary {
  ...
  public ListPractices200ResponseDataInnerContactsPrimary name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ListPractices200ResponseDataInnerContactsPrimary phone(@javax.annotation.Nullable String phone) {
  ...
  /**
   * Return true if this listPractices_200_response_data_inner_contacts_primary object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListPractices200ResponseDataInnerContactsPrimary listPractices200ResponseDataInnerContactsPrimary = (ListPractices200ResponseDataInnerContactsPrimary) o;
    return Objects.equals(this.email, listPractices200ResponseDataInnerContactsPrimary.email) &&
        Objects.equals(this.name, listPractices200ResponseDataInnerContactsPrimary.name) &&
        equalsNullable(this.phone, listPractices200ResponseDataInnerContactsPrimary.phone);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListPractices200ResponseDataInnerContactsPrimary {\n");
