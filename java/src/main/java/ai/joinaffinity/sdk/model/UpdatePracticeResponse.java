 ...
 */
@JsonPropertyOrder({
  UpdatePracticeResponse.JSON_PROPERTY_ADDRESS,
...
public class UpdatePracticeResponse {
  ...
  public UpdatePracticeResponse() {
  }

  public UpdatePracticeResponse address(@javax.annotation.Nullable ListPracticesResponseDataInnerAddress address) {
  ...
  public UpdatePracticeResponse contacts(@javax.annotation.Nonnull ListPracticesResponseDataInnerContacts contacts) {
  ...
  public UpdatePracticeResponse externalId(@javax.annotation.Nullable String externalId) {
  ...
  public UpdatePracticeResponse legalName(@javax.annotation.Nullable String legalName) {
  ...
  public UpdatePracticeResponse livemode(@javax.annotation.Nonnull Boolean livemode) {
  ...
  public UpdatePracticeResponse name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdatePracticeResponse _object(@javax.annotation.Nonnull ObjectEnum _object) {
  ...
  public UpdatePracticeResponse prescribers(@javax.annotation.Nonnull List<ListPracticesResponseDataInnerPrescribersInner> prescribers) {
    this.prescribers = prescribers;
    return this;
  }

  public UpdatePracticeResponse addPrescribersItem(ListPracticesResponseDataInnerPrescribersInner prescribersItem) {
  ...
  public UpdatePracticeResponse supportEmail(@javax.annotation.Nullable String supportEmail) {
  ...
  public UpdatePracticeResponse supportPhone(@javax.annotation.Nullable String supportPhone) {
  ...
  public UpdatePracticeResponse timezone(@javax.annotation.Nonnull String timezone) {
  ...
  /**
   * Return true if this UpdatePracticeResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdatePracticeResponse updatePracticeResponse = (UpdatePracticeResponse) o;
    return Objects.equals(this.address, updatePracticeResponse.address) &&
  ...
  public String toString() {
    ...
    sb.append("class UpdatePracticeResponse {\n");
