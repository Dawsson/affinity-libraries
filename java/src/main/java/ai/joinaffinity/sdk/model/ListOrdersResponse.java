...
import ai.joinaffinity.sdk.model.ListOrdersResponseDataInner;
 ...
 */
@JsonPropertyOrder({
  ListOrdersResponse.JSON_PROPERTY_DATA,
  ListOrdersResponse.JSON_PROPERTY_HAS_MORE,
  ListOrdersResponse.JSON_PROPERTY_OBJECT,
  ListOrdersResponse.JSON_PROPERTY_URL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListOrdersResponse {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nonnull
  private List<ListOrdersResponseDataInner> data = new ArrayList<>();
   ...
   */
  public enum UrlEnum {
    _V1_ORDERS(String.valueOf("/v1/orders"));
  ...
  public ListOrdersResponse data(@javax.annotation.Nonnull List<ListOrdersResponseDataInner> data) {
    this.data = data;
    return this;
  }

  public ListOrdersResponse addDataItem(ListOrdersResponseDataInner dataItem) {
    if (this.data == null) {
  ...
  public List<ListOrdersResponseDataInner> getData() {
    return data;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@javax.annotation.Nonnull List<ListOrdersResponseDataInner> data) {
    this.data = data;
  }


  public ListOrdersResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public ListOrdersResponse _object(@javax.annotation.Nonnull ObjectEnum _object) {
  ...
  public ListOrdersResponse url(@javax.annotation.Nonnull UrlEnum url) {
    this.url = url;
    return this;
  }
  ...
  /**
   * Return true if this ListOrdersResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listOrdersResponse.data) &&
        Objects.equals(this.hasMore, listOrdersResponse.hasMore) &&
        Objects.equals(this._object, listOrdersResponse._object) &&
        Objects.equals(this.url, listOrdersResponse.url);
  }
