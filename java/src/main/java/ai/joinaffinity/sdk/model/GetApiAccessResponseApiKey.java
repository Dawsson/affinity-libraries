...
public class GetApiAccessResponseApiKey {
  ...
  public GetApiAccessResponseApiKey _object(@javax.annotation.Nonnull ObjectEnum _object) {
  ...
  /**
   * Return true if this GetApiAccessResponse_apiKey object is equal to o.
   */
  @Override
