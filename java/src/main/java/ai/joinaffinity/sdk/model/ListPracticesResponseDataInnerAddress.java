 ...
 */
@JsonPropertyOrder({
  ListPracticesResponseDataInnerAddress.JSON_PROPERTY_CITY,
  ListPracticesResponseDataInnerAddress.JSON_PROPERTY_COUNTRY,
  ListPracticesResponseDataInnerAddress.JSON_PROPERTY_LINE1,
  ListPracticesResponseDataInnerAddress.JSON_PROPERTY_LINE2,
  ListPracticesResponseDataInnerAddress.JSON_PROPERTY_POSTAL_CODE,
  ListPracticesResponseDataInnerAddress.JSON_PROPERTY_STATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.22.0")
public class ListPracticesResponseDataInnerAddress {
  ...
  public ListPracticesResponseDataInnerAddress() {
  }

  public ListPracticesResponseDataInnerAddress city(@javax.annotation.Nonnull String city) {
    this.city = city;
    return this;
  }
  ...
  public ListPracticesResponseDataInnerAddress line1(@javax.annotation.Nonnull String line1) {
    this.line1 = line1;
    return this;
  }
  ...
  public ListPracticesResponseDataInnerAddress postalCode(@javax.annotation.Nonnull String postalCode) {
  ...
  public ListPracticesResponseDataInnerAddress state(@javax.annotation.Nonnull String state) {
    this.state = state;
    return this;
  }
  ...
  /**
   * Return true if this ListPracticesResponse_data_inner_address object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListPracticesResponseDataInnerAddress listPracticesResponseDataInnerAddress = (ListPracticesResponseDataInnerAddress) o;
  ...
  public String toString() {
    ...
    sb.append("class ListPracticesResponseDataInnerAddress {\n");
