...
export class APIKeysApi extends runtime.BaseAPI {
     ...
     * Read API key access
     */
    async getApiAccessRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetApiAccess200Response>> {
        const requestOptions = await this.getApiAccessRequestOpts();
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetApiAccess200ResponseFromJSON(jsonValue));
    }
     ...
     * Read API key access
     */
    async getApiAccess(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetApiAccess200Response> {
