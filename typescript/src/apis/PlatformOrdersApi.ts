...
export class PlatformOrdersApi extends runtime.BaseAPI {
     ...
     * List order events
     */
    async listOrderEventsRaw(requestParameters: ListOrderEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListOrderEventsResponse>> {
        const requestOptions = await this.listOrderEventsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ListOrderEventsResponseFromJSON(jsonValue));
    }

    /**
     * List order events
     */
    async listOrderEvents(requestParameters: ListOrderEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListOrderEventsResponse> {
     ...
     * Submit order
     */
    async submitOrderRaw(requestParameters: SubmitOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmitOrderResponse>> {
        const requestOptions = await this.submitOrderRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SubmitOrderResponseFromJSON(jsonValue));
    }
     ...
     * Submit order
     */
    async submitOrder(requestParameters: SubmitOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmitOrderResponse> {
     ...
     * Update draft order
     */
    async updateOrderRaw(requestParameters: UpdateOrderOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateOrderResponse>> {
     ...
     * Update draft order
     */
    async updateOrder(requestParameters: UpdateOrderOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpdateOrderResponse> {
