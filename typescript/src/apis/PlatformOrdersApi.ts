...
export class PlatformOrdersApi extends runtime.BaseAPI {
     ...
     * Read order
     */
    async getOrderRaw(requestParameters: GetOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateOrder200Response>> {
     ...
     * Read order
     */
    async getOrder(requestParameters: GetOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateOrder200Response> {
     ...
     */
    async listOrderEventsRequestOpts(requestParameters: ListOrderEventsRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
     ...
     * List order events
     */
    async listOrderEventsRaw(requestParameters: ListOrderEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListOrderEvents200Response>> {
        const requestOptions = await this.listOrderEventsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ListOrderEvents200ResponseFromJSON(jsonValue));
    }

    /**
     * List order events
     */
    async listOrderEvents(requestParameters: ListOrderEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListOrderEvents200Response> {
     ...
     */
    async submitOrderRequestOpts(requestParameters: SubmitOrderRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
     ...
     * Submit order
     */
    async submitOrderRaw(requestParameters: SubmitOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateOrder200Response>> {
     ...
     * Submit order
     */
    async submitOrder(requestParameters: SubmitOrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateOrder200Response> {
     ...
     * Update draft order
     */
    async updateOrderRaw(requestParameters: UpdateOrderOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateOrder200Response>> {
     ...
     * Update draft order
     */
    async updateOrder(requestParameters: UpdateOrderOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateOrder200Response> {
