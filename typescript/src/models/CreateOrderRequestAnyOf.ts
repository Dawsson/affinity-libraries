...
export function CreateOrderRequestAnyOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateOrderRequestAnyOf {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateOrderRequestAnyOfToJSONTyped(value?: CreateOrderRequestAnyOf | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
