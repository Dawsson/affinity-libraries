 ...
 */
export function instanceOfGetAccountResponseAccount(value: object): value is GetAccountResponseAccount {
...
export function GetAccountResponseAccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAccountResponseAccount {
    if (json == null) {
        return json;
    }
    return {
...
export function GetAccountResponseAccountToJSONTyped(value?: GetAccountResponseAccount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
