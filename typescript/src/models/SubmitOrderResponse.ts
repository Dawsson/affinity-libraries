...
export function SubmitOrderResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubmitOrderResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function SubmitOrderResponseToJSONTyped(value?: SubmitOrderResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
