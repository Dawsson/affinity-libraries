 ...
 */
export function instanceOfListPracticesResponseDataInner(value: object): value is ListPracticesResponseDataInner {
...
export function ListPracticesResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListPracticesResponseDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ListPracticesResponseDataInnerToJSONTyped(value?: ListPracticesResponseDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
