...
export type CreatePractice200ResponseObjectEnum = typeof CreatePractice200ResponseObjectEnum[keyof typeof CreatePractice200ResponseObjectEnum];


/**
 * Check if a given object implements the CreatePractice200Response interface.
 */
export function instanceOfCreatePractice200Response(value: object): value is CreatePractice200Response {
...
export function CreatePractice200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatePractice200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'name': json['name'],
        'object': json['object'],
        'prescribers': ((json['prescribers'] as Array<any>).map(CreatePracticeRequestPrescribersInnerFromJSON)),
...
export function CreatePractice200ResponseToJSONTyped(value?: CreatePractice200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'name': value['name'],
        'object': value['object'],
        'prescribers': ((value['prescribers'] as Array<any>).map(CreatePracticeRequestPrescribersInnerToJSON)),
