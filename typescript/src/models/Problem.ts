...
export function ProblemFromJSONTyped(json: any, ignoreDiscriminator: boolean): Problem {
    ...
    return {
        ...
        'code': json['code'],
        'detail': json['detail'],
        'errors': json['errors'] == null ? undefined : ((json['errors'] as Array<any>).map(ProblemErrorFromJSON)),
...
export function ProblemToJSONTyped(value?: Problem | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'code': value['code'],
        'detail': value['detail'],
        'errors': value['errors'] == null ? undefined : ((value['errors'] as Array<any>).map(ProblemErrorToJSON)),
