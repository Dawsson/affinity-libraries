 ...
 */
export function instanceOfCreateOrder200ResponseOrder(value: object): value is CreateOrder200ResponseOrder {
...
export function CreateOrder200ResponseOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateOrder200ResponseOrder {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateOrder200ResponseOrderToJSONTyped(value?: CreateOrder200ResponseOrder | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
