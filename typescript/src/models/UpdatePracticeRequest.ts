...
export function UpdatePracticeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdatePracticeRequest {
    if (json == null) {
        return json;
    }
    return {

        'address': json['address'] == null ? undefined : CreateOrderRequestAnyOfPatientAddressFromJSON(json['address']),
        'attestations': json['attestations'] == null ? undefined : CreatePracticeRequestAttestationsFromJSON(json['attestations']),
        'complianceContact': json['complianceContact'] == null ? undefined : CreatePracticeRequestComplianceContactFromJSON(json['complianceContact']),
        'externalId': json['externalId'] == null ? undefined : json['externalId'],
        'legalName': json['legalName'] == null ? undefined : json['legalName'],
        'metadata': json['metadata'] == null ? undefined : json['metadata'],
        'name': json['name'] == null ? undefined : json['name'],
        'prescribers': json['prescribers'] == null ? undefined : ((json['prescribers'] as Array<any>).map(CreatePracticeRequestPrescribersInnerFromJSON)),
        'primaryContact': json['primaryContact'] == null ? undefined : CreatePracticeRequestComplianceContactFromJSON(json['primaryContact']),
...
export function UpdatePracticeRequestToJSONTyped(value?: UpdatePracticeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'name': value['name'],
        'prescribers': value['prescribers'] == null ? undefined : ((value['prescribers'] as Array<any>).map(CreatePracticeRequestPrescribersInnerToJSON)),
