...
export function CreatePracticeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreatePracticeRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreatePracticeRequestToJSONTyped(value?: CreatePracticeRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
