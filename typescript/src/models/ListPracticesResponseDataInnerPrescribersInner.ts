...
export function ListPracticesResponseDataInnerPrescribersInnerFromJSON(json: any): ListPracticesResponseDataInnerPrescribersInner {
    return ListPracticesResponseDataInnerPrescribersInnerFromJSONTyped(json, false);
}

export function ListPracticesResponseDataInnerPrescribersInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListPracticesResponseDataInnerPrescribersInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ListPracticesResponseDataInnerPrescribersInnerToJSON(json: any): ListPracticesResponseDataInnerPrescribersInner {
    return ListPracticesResponseDataInnerPrescribersInnerToJSONTyped(json, false);
}

export function ListPracticesResponseDataInnerPrescribersInnerToJSONTyped(value?: ListPracticesResponseDataInnerPrescribersInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
