 ...
 */
export function instanceOfCreateOrderRequestAnyOfPatient(value: object): value is CreateOrderRequestAnyOfPatient {
...
export function CreateOrderRequestAnyOfPatientFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateOrderRequestAnyOfPatient {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateOrderRequestAnyOfPatientToJSONTyped(value?: CreateOrderRequestAnyOfPatient | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
