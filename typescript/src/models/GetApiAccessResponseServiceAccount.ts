...
export type GetApiAccessResponseServiceAccountObjectEnum = typeof GetApiAccessResponseServiceAccountObjectEnum[keyof typeof GetApiAccessResponseServiceAccountObjectEnum];
...
export function GetApiAccessResponseServiceAccountFromJSON(json: any): GetApiAccessResponseServiceAccount {
    return GetApiAccessResponseServiceAccountFromJSONTyped(json, false);
}

export function GetApiAccessResponseServiceAccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetApiAccessResponseServiceAccount {
    if (json == null) {
        return json;
    }
    return {
...
export function GetApiAccessResponseServiceAccountToJSON(json: any): GetApiAccessResponseServiceAccount {
    return GetApiAccessResponseServiceAccountToJSONTyped(json, false);
}

export function GetApiAccessResponseServiceAccountToJSONTyped(value?: GetApiAccessResponseServiceAccount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
