 ...
 */
export function instanceOfGetPlatformOrganization200ResponseAccount(value: object): value is GetPlatformOrganization200ResponseAccount {
    if (!('alertEmails' in value) || value['alertEmails'] === undefined) return false;
    if (!('alertIntegrationIssues' in value) || value['alertIntegrationIssues'] === undefined) return false;
...
export function GetPlatformOrganization200ResponseAccountFromJSON(json: any): GetPlatformOrganization200ResponseAccount {
    return GetPlatformOrganization200ResponseAccountFromJSONTyped(json, false);
}

export function GetPlatformOrganization200ResponseAccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetPlatformOrganization200ResponseAccount {
    if (json == null) {
        return json;
    }
    return {
...
export function GetPlatformOrganization200ResponseAccountToJSON(json: any): GetPlatformOrganization200ResponseAccount {
    return GetPlatformOrganization200ResponseAccountToJSONTyped(json, false);
}

export function GetPlatformOrganization200ResponseAccountToJSONTyped(value?: GetPlatformOrganization200ResponseAccount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
