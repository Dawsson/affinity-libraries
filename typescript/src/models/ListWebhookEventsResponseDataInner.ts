...
export function ListWebhookEventsResponseDataInnerFromJSON(json: any): ListWebhookEventsResponseDataInner {
    return ListWebhookEventsResponseDataInnerFromJSONTyped(json, false);
}

export function ListWebhookEventsResponseDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListWebhookEventsResponseDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ListWebhookEventsResponseDataInnerToJSON(json: any): ListWebhookEventsResponseDataInner {
    return ListWebhookEventsResponseDataInnerToJSONTyped(json, false);
}

export function ListWebhookEventsResponseDataInnerToJSONTyped(value?: ListWebhookEventsResponseDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
